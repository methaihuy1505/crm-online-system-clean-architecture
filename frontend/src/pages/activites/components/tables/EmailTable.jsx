...
export const EmailTable = ({ data, onEdit, onDelete, onToggleCompleted, onTogglePriority, onSortParentType, labelSubject = "Chủ đề Email" }) => (
  <table className="w-full text-left border-collapse">
    <thead className="bg-slate-50 border-b border-slate-200">
      <tr>
        <th className="p-3 font-semibold text-slate-600">{labelSubject}</th>
        <th className="p-3 font-semibold text-slate-600">Ngày gửi</th>
