...
export const MeetingTable = ({ data, onEdit, onDelete, onToggleCompleted, onTogglePriority, onSortParentType, canView, canUpdate, canDelete, selectedRow, onRowClick, onRowDoubleClick }) => (
  <table className="w-full text-left border-collapse">
    <thead className="bg-slate-50 border-b border-slate-200">
      <tr>
        <th className="p-3 font-semibold text-slate-600 sticky top-0 bg-slate-50">Chủ đề</th>
        <th className="p-3 font-semibold text-slate-600 sticky top-0 bg-slate-50">Ngày bắt đầu</th>
