...
export const NoteTable = ({ data, onEdit, onDelete, onToggleCompleted, onTogglePriority, onSortParentType }) => (
  <table className="w-full text-left border-collapse">
    <thead className="bg-slate-50 border-b border-slate-200">
      <tr>
        <th className="p-3 font-semibold text-slate-600">Chủ đề</th>
        <th className="p-3 font-semibold text-slate-600">Ngày ghi chú</th>
