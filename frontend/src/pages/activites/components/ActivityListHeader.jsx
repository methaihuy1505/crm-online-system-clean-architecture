  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        >
          <Plus className="w-4 h-4" /> Tạo hoạt động (Ctrl + M)
        </button>
      </div>

      {/* 2. Thanh Tìm kiếm & Trigger lọc nâng cao */}
      <div className="mb-4 grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
        <div className="md:col-span-2 flex gap-2">
          ...
          />
          <button onClick={() => onSearch(keyword)} className="bg-slate-200 hover:bg-slate-300 px-4 py-2 rounded-[5px]">
      ...
      {/* 3. Thanh điều hướng Tabs chuyển loại */}
