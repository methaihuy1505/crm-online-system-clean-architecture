...
const ActivityFilter = ({
  ...
  /**
   *Logic chọn DUY NHẤT (Dành cho Loại hoạt động)
   * Bấm cái mới thì thay thế cái cũ, bấm lại cái đang chọn thì bỏ chọn (về mảng rỗng)
   */
  ...
  /**
   * Logic chọn NHIỀU (Dành cho Đối tượng liên quan, Priority, Completed)
   */
