    ...
    <aside className="h-screen w-64 fixed left-0 top-0 border-r-0 bg-white dark:bg-slate-900 shadow-[32px_0_32px_-4px_rgba(25,28,29,0.06)] z-50">
      <div className="flex flex-col h-full p-4 gap-2">
        ...
        <nav className="flex-1 space-y-1">
          <a className="flex items-center gap-3 text-slate-600 dark:text-slate-400 px-4 py-3 hover:bg-[#f3f4f5] transition-all duration-300" href="#">
            <span className="material-symbols-outlined">dashboard</span>
            <span className="font-medium text-sm">Bảng điều khiển</span>
          </a>
          <a className="flex items-center gap-3 bg-[#f3f4f5] dark:bg-slate-800 text-[#1A237E] dark:text-white rounded-lg px-4 py-3 transition-all duration-300" href="#">
