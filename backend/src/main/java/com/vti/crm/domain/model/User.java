...
public class User {
    ...
    private final Integer id;            // Giữ nguyên final
    ...
    // ĐÃ XÓA TỪ KHÓA 'final' Ở 3 TRƯỜNG DƯỚI ĐÂY ĐỂ CHO PHÉP CHỈNH SỬA
    private Integer roleId;
    private Integer branchId;
    private Integer teamId;

    private Status status;
    private final LocalDateTime createdAt; // Giữ nguyên final
    ...
    // CẬP NHẬT METHOD: Đã thêm các trường tổ chức vào tham số
